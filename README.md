...
```
### Dataset
For the graph classiciation datasets, directly run our code and a file folder `data` would be set up and the data would be put in it. If you want to change the name, you could change the name of the data path in `--datapath` setting in `main_oneDS.py`.
